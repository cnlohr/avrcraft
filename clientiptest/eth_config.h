...
//The ARP table matches IPs to MACs.
//Each ARP entry takes 10 bytes.
#define ARP_CLIENT_SUPPORT
#define ARP_CLIENT_TABLE_SIZE 8

//Add PING support
//Each ping entry looks to be around 11 bytes.
#define PING_CLIENT_SUPPORT
#define PING_RESPONSES_SIZE 8
